...
<div id="stat_detail">
            <div id="stat_tab">
			<?php if($_GET['type'] == ''): ?><a href="<?php echo U('data/dejia');?>" class="sel">积分榜</a>
			<?php else: ?>
                <a href="<?php echo U('data/dejia');?>" >积分榜</a><?php endif; ?>	
			<?php if($_GET['type'] == 'schedule'): ?><a href="<?php echo U('data/dejia',array('type'=>'schedule'));?>" id="schdule" class="sel">赛程表</a>
			<?php else: ?>
				<a href="<?php echo U('data/dejia',array('type'=>'schedule'));?>" id="schdule">赛程表</a><?php endif; ?>
            </div>
